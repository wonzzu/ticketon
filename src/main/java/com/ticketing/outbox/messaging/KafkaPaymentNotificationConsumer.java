...
import com.ticketing.outbox.service.PaymentNotificationHandler;
...
public class KafkaPaymentNotificationConsumer {
    ...
    private final PaymentNotificationHandler notificationHandler;
    ...
    private void handleCompleted(
        ...
        notificationHandler.handleCompleted(
                envelope.eventId(),
                payload
        );
    }
    ...
    private void handleCanceled(
        ...
        notificationHandler.handleCanceled(
                envelope.eventId(),
                payload
        );
    }
